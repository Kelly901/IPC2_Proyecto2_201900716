...
from NodoEncabezadoT import NodoEncabezadoT
from EncabezadoT import EncabezadoT
class MatrizTransp:

    def __init__(self):

        self.encabezadoFilas= EncabezadoT()
        self.encabezadoColumnas=EncabezadoT()


    def insertar(self,fila,columna,valor):
        
        nuevo=NodoT(fila,columna,valor)

        efilas=self.encabezadoFilas.getEncabezado(fila)

        if efilas==None:
            efilas=NodoEncabezadoT(fila)
            efilas.acceso=nuevo
        ...
        if eColumnas==None:
            eColumnas=NodoEncabezadoT(columna)
