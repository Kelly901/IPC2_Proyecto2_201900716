...
from NodoEncabezadoH import NodoEncabezadoH
from EncabezadoH import EncabezadoH
class MatrizHorizontal:

    def __init__(self):

        self.encabezadoFilas= EncabezadoH()
        self.encabezadoColumnas=EncabezadoH()


    def insertar(self,fila,columna,valor):
        
        nuevo=NodoH(fila,columna,valor)

        efilas=self.encabezadoFilas.getEncabezado(fila)

        if efilas==None:
            efilas=NodoEncabezadoH(fila)
            efilas.acceso=nuevo
        ...
        if eColumnas==None:
            eColumnas=NodoEncabezadoH(columna)
