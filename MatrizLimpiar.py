from NodoLimpiar import NodoLimpiar
from NodoEncabezadoLim import NodoEncabezadoLim
from EncabezadoLimpiar import EncabezadoLimpiar
...
class MatrizLimpiar:
    ...
    def __init__(self):
        ...
        self.encabezadoFilas = EncabezadoLimpiar()
        self.encabezadoColumnas = EncabezadoLimpiar()

    def insertar(self, fila, columna, valor):

        nuevo = NodoLimpiar(fila, columna, valor)

        efilas = self.encabezadoFilas.getEncabezado(fila)

        if efilas == None:
            efilas = NodoEncabezadoLim(fila)
            efilas.acceso = nuevo
        ...
        if eColumnas == None:
            eColumnas = NodoEncabezadoLim(columna)
